<footer id="footer">
			<div class="grid-row clear">
				<div class="footer">
					<div id="copyright">Copyright<span> COORDINATOR MARKETING & SERVICES</span> 2016-All Rights Reserved</div>
					<a href="index.html" class="footer-logo"><img src="images/textlogo.png" alt=""></a>
					<div class="social">
