            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a href="portfolio.php"><i class="fa fa-globe"></i> Portfolio </a></li>

                    <li><a href="clients.php"><i class="fa fa-server"></i> Our Clients </a></li>
                    <li><a href="team.php"><i class="fa fa-users"></i> Team </a></li>

                    <li><a href="services.php"><i class="fa fa-edit"></i> Services </a></li>
