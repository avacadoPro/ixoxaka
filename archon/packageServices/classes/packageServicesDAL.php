...
class packageservicesDAL
{
    ...
    {		
    	...
    	public function Add($obj){
    		$db=$GLOBALS['pdo'];
            $query="INSERT INTO packageservices( "; 
            $query.=" title "; 
            $query.=") VALUES ("; 
            $query.="'{$obj->title}'"; 
            $query.=");"; 
    	...
    	public function Update($obj){
    		$db=$GLOBALS['pdo'];
            $query="UPDATE packageservices SET "; 
    	...
    	public function Delete($i){
    		$db=$GLOBALS['pdo'];
            $query="DELETE FROM packageservices"; 
            $query.=" WHERE id='{$i}'"; 
            $query.=";"; 
            $db->query($query);
       }
    	public function Find($i){
    		$db=$GLOBALS['pdo'];
            $query="SELECT * FROM packageservices"; 
            $query.=" WHERE id='{$i}'"; 
            $query.=";"; 
    	...
    	public function Search($obj){
    		$db=$GLOBALS['pdo'];
            $query="SELECT * FROM packageservices WHERE "; 
